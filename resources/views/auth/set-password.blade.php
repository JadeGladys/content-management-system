...
<body class="relative min-h-screen overflow-hidden bg-slate-100 text-slate-900">
    <div class="absolute inset-0">
        <img src="/images/login-bg2.jpg" alt="" class="h-full w-full object-cover opacity-40">
    </div>
    ...
    <main class="relative z-10 flex min-h-screen items-center justify-center px-4 py-8">
        <div class="w-full max-w-md rounded-3xl border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/60">
            <div class="mb-8">
                <h1 class="text-3xl font-bold text-slate-900">Set Password</h1>
                <p class="mt-3 text-sm leading-6 text-slate-600">
                    Create a strong password for your ISCO CMS account.
                </p>
            ...
            <form method="POST" action="{{ route('password.setup.update') }}" class="space-y-6">
                @csrf
